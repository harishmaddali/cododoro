...
export function Welcome({ status, onContinue, onNeedsAuth }: Props) {
  ...
  return (
    <div className="screen bg-grid" style={{ display: "flex", flexDirection: "column" }}>
      <div
        style={{
          padding: "20px 24px 0",
          display: "flex",
  ...
  if (kind === "ring") {
    return (
      ...
      >
        ...
        >
          <div>
            <div className="t-mono" style={{ fontSize: 48, fontWeight: 500, lineHeight: 1 }}>
              4<span style={{ color: "var(--fg-3)" }}>/5</span>
            </div>
            <div className="t-small" style={{ marginTop: 6, color: "var(--grass-4)" }}>
              commits today
            </div>
          </div>
        </div>
